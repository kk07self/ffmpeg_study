...
#pragma mark - RGB Render
@interface MovieGLRenderer_RGB : NSObject<MovieGLRenderer> {
...
@implementation MovieGLRenderer_RGB
...
#pragma mark - YUV Render
@interface MovieGLRenderer_YUV : NSObject<MovieGLRenderer> {
...
@implementation MovieGLRenderer_YUV
...
- (void)commonInit {
    // render init
    if (_format == VideoFrameFormatYUV) {
        // yuv
        _renderer = [[MovieGLRenderer_YUV alloc] init];
    } else {
        _renderer = [[MovieGLRenderer_RGB alloc] init];
    }
